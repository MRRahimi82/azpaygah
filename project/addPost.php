...
if(!Authorization::checkAccess()){
    ...
    if( isset( $_POST['submit'] ) ){
        ...
        $sql = "INSERT INTO product(creator,type,brand,model,tavanhararati,price,cover,state) 
        VALUES(?,?,?,?,?,?,?,?)";

        $result = $dbc -> query( $sql, $id, $_POST['type'], $_POST['brand'],
            $_POST['model'], $_POST['tavanhararati'], $_POST['price'], $img_name, $_POST['state']);
